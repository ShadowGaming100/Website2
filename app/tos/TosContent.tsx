  ...
  return (
    <div className="tos-content wrap">
      ...
      <div className="toc">
        ...
        <ul>
          <li>
            <a href="#agreement">AGREEMENT TO OUR LEGAL TERMS</a>
          </li>
          <li>
          ...
          <li>
            <a href="#license">6. CONTRIBUTION LICENCE</a>
          </li>
          <li>
            <a href="#reviews">7. GUIDELINES FOR REVIEWS</a>
          </li>
          <li>
            <a href="#thirdparty">8. THIRD-PARTY WEBSITES AND CONTENT</a>
          </li>
          <li>
          ...
          <li>
            <a href="#terms">11. TERM AND TERMINATION</a>
          </li>
          <li>
            <a href="#modifications">12. MODIFICATIONS AND INTERRUPTIONS</a>
          </li>
          <li>
            <a href="#law">13. GOVERNING LAW</a>
          </li>
          <li>
            <a href="#disputes">14. DISPUTE RESOLUTION</a>
          </li>
          <li>
          ...
          <li>
            <a href="#liability">17. LIMITATIONS OF LIABILITY</a>
          </li>
          <li>
            <a href="#indemnification">18. INDEMNIFICATION</a>
          </li>
          <li>
            <a href="#userdata">19. USER DATA</a>
          </li>
          <li>
            <a href="#electronic">
      ...
      <div className="highlight-box">
        <p>
          <strong>IMPORTANT:</strong> These Legal Terms constitute a legally
          binding agreement made between you, whether personally or on behalf of
          an entity ({"'"}
          <strong>you</strong>
          {"'"}
          ), and <span className="question">FreeHosts</span>, concerning your
      ...
      <p>
        ...
        unauthorised purpose; and (6) your use of the Services will not violate
      ...
      <ul>
        ...
        <li>
          ...
          {"'"} or {"'"}
          <strong>passive collection mechanisms</strong>
          {"'"} or {"'"}
          <strong>pcms</strong>
          {"'"}
          ).
        ...
        <li>
          <span className="question">
            Users may not use the platform to promote or host content that
            violates any applicable law or regulation (e.g. copyright
            infringement, fraud, terrorism, etc.).
          </span>
        </li>
        <li>
          <span className="question">
            Users must not submit or link to hosting providers that distribute
            malware, viruses, trojans, or other harmful or destructive code.
          </span>
        </li>
        <li>
          <span className="question">
            Users may not use the service for spamming, sending chain letters,
            phishing attempts, or other unsolicited bulk communications.
          </span>
        </li>
        <li>
          <span className="question">
            It{"'"}s prohibited to impersonate another user, a hosting provider,
            or otherwise mislead other users about your affiliation or identity.
          </span>
        </li>
        <li>
          <span className="question">
            Users must not use the platform to facilitate or plan
            denial-of-service attacks, scanning of networks, hacking, or other
            unauthorized access activities.
          </span>
        </li>
        <li>
          <span className="question">
            Users may not promote or list hosting services that explicitly
            provide or host illegal pornography, exploitative content, or child
            sexual abuse material.
          </span>
        </li>
        <li>
          <span className="question">
            Users may not link to or list hosts that facilitate copyright
            infringement, piracy, or distribution of unlicensed content (e.g.
            pirated software, ROMs, cracked programs).
          </span>
        </li>
        <li>
          <span className="question">
            Users should not list or promote hosts that are primarily used for
            high-yield investment programs (HYIP), pyramid schemes, or other
            financially risky or fraudulent activities.
          </span>
        </li>
        <li>
          <span className="question">
            Users may not list hosts that use the platform to run abusive
            cryptocurrency mining (e.g. secretly using visitor CPU), or hosts
            that facilitate illicit financial services.
          </span>
        </li>
        <li>
          <span className="question">
            It{"'"}s prohibited to use the platform in a way that bypasses
            security restrictions (for example, removing copyright notices, or
        ...
        <li>
          <span className="question">
            Users may not list or use hosts in a way that would significantly
            overburden infrastructure (e.g. continuous heavy scraping, automated
            crawling without consent).
          </span>
        </li>
      </ul>
      ...
      <h2 id="license">6. CONTRIBUTION LICENCE</h2>
      ...
      <h2 id="reviews">7. GUIDELINES FOR REVIEWS</h2>

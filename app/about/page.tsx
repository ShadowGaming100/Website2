  ...
  const values = [
    {
      ...
      description:
        "Every hosting provider undergoes rigorous manual verification. No paid placements.",
    },
    {
      icon: ["fas", "users"] as IconProp,
      title: "Community First",
      description:
        "Built by developers, for developers. Powered by collective knowledge.",
    },
    {
      icon: ["fas", "rocket"] as IconProp,
      title: "Innovation & Quality",
      description:
        "We prioritize providers with modern infrastructure and excellent performance.",
    },
    {
      icon: ["fas", "book-open"] as IconProp,
      title: "Education & Support",
      description:
        "Comprehensive guides and documentation to help you deploy successfully.",
    },
  ];
  ...
  const timeline = [
    {
      ...
      title: "The Beginning",
      description:
        "Founded to solve the challenge of finding reliable free hosting.",
    },
    {
      year: "2024",
      title: "Platform Expansion",
      description:
        "Added Discord bot hosting, databases, VPS services, and automated monitoring.",
    },
    {
      year: "2025",
      title: "Community Milestone",
      description:
        "Reached 500+ Discord members and 100+ verified hosting providers.",
    },
    {
      year: "2026",
      title: "Sustained Excellence",
      description:
        "Continuing to grow while maintaining quality and transparency.",
    },
  ];
  ...
  const verification = [
    {
      ...
      title: "Submission",
      description:
        "Providers submit through our form or community recommendations.",
    },
    {
      step: "02",
      title: "Technical Review",
      description:
        "We review specs, terms, privacy policy, and verify no hidden fees.",
    },
    {
      step: "03",
      title: "Hands-on Testing",
      description:
        "Real applications deployed to test actual performance over weeks.",
    },
    {
      step: "04",
      title: "Community Validation",
      description: "Shared with community for additional feedback and testing.",
    },
    {
      step: "05",
      title: "Continuous Monitoring",
      description:
        "Post-listing monitoring for uptime, performance, and changes.",
    },
  ];
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="max-w-2xl">
                ...
                <p className="body-default text-[rgb(var(--muted))] text-balance">
                  We&apos;re on a mission to democratize web hosting by
                  connecting developers with reliable, truly free hosting
                  solutions. No scams, no hidden fees.
                </p>
              </div>
              <div className="flex-shrink-0">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-[rgb(var(--accent)/0.1)] flex items-center justify-center">
                  <FontAwesomeIcon
                    ...
                    className="text-3xl text-[rgb(var(--accent))]"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-[rgb(var(--border))]">
              {stats.map((stat, i) => (
                <div key={i} className="text-center">
                  <div className="text-xl md:text-2xl font-bold text-[rgb(var(--accent))] mb-1">
                    {stat.value}
                  </div>
                  <div className="text-[10px] md:text-xs font-semibold text-[rgb(var(--muted))] uppercase tracking-wider">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          <div className="container-tight">
            ...
            >
              ...
              <div className="space-y-4 body-default text-[rgb(var(--muted))]">
                <p>
                  FreeHosts was founded in 2023 after our team spent weeks
                  searching for reliable free hosting for side projects, Discord
                  bots, and portfolio websites. The landscape was filled with
                  scams, hidden fees, and services that suddenly disappeared.
                </p>
                <p>
                  We realized there had to be a better way. While legitimate
                  free hosting providers existed, finding them meant sifting
                  through outdated forums and promotional content. We needed a
                  curated, verified directory.
                </p>
                <p>
                  So we built FreeHosts—a community-driven platform where every
                  hosting provider is manually verified and tested. We
                  don&apos;t accept payment for listings, and our rankings are
                  never influenced by affiliates.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section className="section-padding bg-gradient-to-b from-transparent to-[rgb(var(--muted)/0.03)]">
          <div className="container-default">
            ...
            >
              ...
              <p className="body-default text-[rgb(var(--muted))] max-w-2xl mx-auto">
                Every hosting provider goes through rigorous testing before
                being listed.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <p className="text-lg text-white/80 mb-8">
                  Connect with thousands of developers on Discord. Share

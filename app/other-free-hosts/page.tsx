  ...
  const platforms = [
    {
      ...
      short: 'FMH',
      description: 'Curated collection of free hosting providers specifically for Minecraft servers featuring detailed reviews, comparisons, and community ratings within various configurations and performance options.',
    ...
    },
    {
      ...
      description: 'A comprehensive directory dedicated to free Minecraft server hosting providers, helping you find the perfect host for your server.',
  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--bg))]">
        ...
        <div className="container-default">
          ...
          >
            ...
            <h1 className="heading-1 text-[rgb(var(--text))] mb-4">
              Other Free <span className="text-[rgb(var(--accent))]">Hosting Platforms</span>
            </h1>
      ...
      <div className="container-default pb-24">
        ...
        {/* Section Header */}
        <div className="mb-8">
          <h2 className="heading-3 text-[rgb(var(--text))]">Specialized Directories</h2>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="w-14 h-14 rounded-xl gradient-bg flex items-center justify-center text-white font-bold text-lg shadow-sm overflow-hidden flex-shrink-0">
                  {platform.image ? (
                    <Image src={platform.image} alt={platform.name} width={56} height={56} className="w-full h-full object-cover" />
                  ) : (

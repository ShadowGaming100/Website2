    ...
    <div className="tos-content wrap">
      ...
      <div className="toc">
        ...
        <ul>
          ...
          <li>
            <a href="#legalbases">3. WHAT LEGAL BASES DO WE RELY ON?</a>
          </li>
          <li>
            <a href="#whoshare">
          ...
          <li>
            <a href="#cookies">5. DO WE USE COOKIES AND TRACKING TECHNOLOGIES?</a>
          </li>
          <li>
      ...
      <p>
        <em>In Short:</em> Some information &mdash; such as your Internet
        Protocol (IP) address and/or browser and device characteristics &mdash;
      ...
      <p>
        ...
        permission to use your personal information for a specific purpose, or
      ...
      <p>
        ...
        require access to such information to do that work. We have contracts
        in place with our third parties, which are designed to help safeguard
      ...
      <p>
        <em>In Short:</em> We may use cookies and other tracking technologies
      ...
      <p>
        <em>In Short:</em> We keep your information for as long as necessary to
      ...
      <p>
        <em>In Short:</em> Depending on your state of residence in the US or in
      ...
      <p>
        You have rights under certain US state data protection laws. These rights
        include:
      </p>
      ...
      <p>
        <strong>Note:</strong> Due to the nature of the analytics data we collect
        (which is anonymized and aggregated), we are unable to provide
        individual data correction, deletion, or data portability for this
        information. We do not use personal data for targeted advertising
        purposes.
      </p>
      ...
      <p>
        <em>In Short:</em> Yes, we will update this notice as necessary to stay

    ...
    return (
        <div className="min-h-screen bg-[rgb(var(--bg))]">
            ...
            <section className="relative">
                ...
                <div className="relative min-h-[36rem] lg:h-[40rem] overflow-hidden flex flex-col lg:block">
                    {/* Background - Full cover on desktop, background for top part on mobile */}
                    <div className="absolute inset-0 w-full h-full gradient-bg z-0" />
                    <div className="absolute inset-0 bg-gradient-to-t from-[rgb(var(--bg))] via-[rgb(var(--bg)/0.4)] to-transparent z-0" />

                    {/* Hero Content */}
                    <div className="container-default relative z-10 pt-24 pb-12 lg:pt-0 lg:pb-0 lg:absolute lg:inset-0 lg:flex lg:items-center">
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
                            ...
                            <motion.div
                                ...
                                className="hidden lg:block w-full max-w-lg mx-auto lg:max-w-none"
                            >
                                <Terminal />
                            </motion.div>
                        </div>
                ...
                <div className="container-default relative z-20 -mt-8 lg:-mt-16">
                    <motion.div
                    ...
                    >
                        {stats.map((stat, i) => (
                            <div
                                key={i}
                                className="bg-[rgb(var(--card))] rounded-2xl border border-[rgb(var(--border))] shadow-large p-5 md:p-6 flex flex-col items-center text-center group hover:border-[rgb(var(--accent))] transition-all"
                            >
                                <div className="w-12 h-12 rounded-xl bg-[rgb(var(--accent)/0.1)] flex items-center justify-center text-[rgb(var(--accent))] mb-3 md:mb-4 group-hover:scale-110 transition-transform">
                                    <FontAwesomeIcon icon={stat.icon} className="text-xl" />
                                </div>
                                <div className="text-2xl md:text-3xl font-bold text-[rgb(var(--text))] mb-1">{stat.value}</div>
                                <div className="text-xs md:text-sm font-semibold text-[rgb(var(--muted))] uppercase tracking-wider">{stat.label}</div>
                            </div>
                        ))}
                    </motion.div>
                </div>

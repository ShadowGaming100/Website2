        ...
        <div className="container-default text-center">
          ...
          >
            ...
            <h1 className="heading-1 text-[rgb(var(--text))] mb-4">
              Submission{" "}
              <span className="text-[rgb(var(--accent))]">Rules</span>
            </h1>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-[rgb(var(--muted))]">
              Failure to follow these guidelines may result in your submission
              being rejected. Submissions not following the required layout will
              be ignored.
            </p>
          </div>
        </motion.div>
          ...
          {ruleCategories.map((category, index) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div
                  className={`w-10 h-10 rounded-lg bg-[rgb(var(--muted)/0.05)] flex items-center justify-center text-[rgb(var(--text))]`}
                >
                  <FontAwesomeIcon icon={category.icon} />
                </div>
                <h3 className="font-semibold text-[rgb(var(--text))] text-lg">
                  {category.title}
                </h3>
              </div>
              <ul className="space-y-3">
                {category.rules.map((rule, i) => (
                  ...
                  >
                    <FontAwesomeIcon
                      icon={["fas", "check"]}
                      className={`text-[rgb(var(--accent))] mt-1 text-xs flex-shrink-0`}
                    />
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
            <div className="flex-1">
              ...
              <p className="body-default text-[rgb(var(--muted))] mb-6">
                ...
                target separately. All hosts must follow the required format.
              </p>
...
Information: (Renewal info, duration, coins needed, notes)`}</pre>
        ...
        <div className="text-center">
          ...
          <p className="body-default text-[rgb(var(--muted))] mb-8">
            If your hosting service meets all the requirements above, you can
            proceed.
          </p>
          <Button
            href="/submit-host"

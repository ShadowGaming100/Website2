    ...
    faqs: [
      {
        ...
        answer: "Yes! All hosting providers listed on FreeHosts offer genuinely free tiers with no credit card required. We rigorously verify that there are no hidden fees or deceptive practices."
      },
      {
        question: "Do I need a credit card to sign up?",
        answer: "No! All providers listed in our directory offer free tiers that don't require credit card information. You can sign up and start hosting immediately with just an email address."
      },
      {
        question: "What can I host for free?",
        answer: "You can host static websites, dynamic web applications, Discord bots, APIs, databases, serverless functions, and more. Different providers specialize in different types of hosting."
      },
      {
        question: "Are there any limitations on free hosting?",
        answer: "Yes, free tiers typically have resource limitations such as bandwidth caps, storage limits, and CPU/RAM restrictions. However, these limits are usually generous enough for personal projects and learning."
      },
    ]
  },
  {
    ...
    faqs: [
      {
        ...
        answer: "Consider your project's needs: the programming language/framework, required resources, geographic location, special features (databases, cron jobs, SSL), and deployment method. Use our filtering system to narrow down providers."
      },
      {
        question: "Which hosting is best for Discord bots?",
        answer: "For Discord bots, look for providers offering 24/7 uptime, persistent processes, adequate RAM (at least 512MB), support for Node.js or Python, and automatic restarts. Filter by 'Discord Bot Hosting' in our directory."
      },
      {
        question: "What's the difference between static and dynamic hosting?",
        answer: "Static hosting serves pre-built HTML, CSS, and JavaScript files—perfect for portfolios and JAMstack apps. Dynamic hosting runs server-side code and can handle databases and real-time functionality."
      },
    ]
  },
  {
    ...
    faqs: [
      {
        ...
        answer: "Yes! Most modern free hosting providers automatically provide free SSL certificates through Let's Encrypt or similar services. HTTPS is now standard even for free tiers."
      },
      {
        question: "Can I use databases with free hosting?",
        answer: "Absolutely! Many free hosting providers include database support. You can find free MySQL, PostgreSQL, MongoDB, Redis, and other database services. Storage limits vary by provider."
      },
      {
        question: "Can I run cron jobs or scheduled tasks?",
        answer: "Many free hosting providers support cron jobs, though this varies. Some platforms offer built-in cron functionality, while others require external services or GitHub Actions."
      },
    ]
  },
  {
    ...
    faqs: [
      {
        ...
        answer: "Reliability varies by provider, which is why we rigorously test and monitor uptime. Many free hosting providers achieve 99%+ uptime, comparable to paid services."
      },
      {
        question: "Will my free hosted site be slow?",
        answer: "Not necessarily! Many free providers use modern infrastructure with NVMe SSDs and CDN integration. Performance depends on the provider and your application's optimization."
      },
      {
        question: "What happens if I exceed the free tier limits?",
        answer: "Most providers will either throttle your service, pause your application, or ask you to upgrade. We document each provider's overage policies in their listing."
      },
    ]
  },
  {
    ...
    faqs: [
      {
        ...
        answer: "Our verification includes manual technical review, hands-on testing with real applications, uptime monitoring, community feedback, and continuous post-listing monitoring."
      },
      {
        question: "Do you get paid to list hosts?",
        answer: "No. We do not accept payment for listings, and rankings are never influenced by affiliate commissions. Providers are listed purely based on quality and community feedback."
      },
      {
        question: "How can I submit a hosting provider?",
        answer: "Visit our Submit page or share it in our Discord community. Our team will review, verify, and add it if it meets our quality standards."
      },
    ]
  },
];
        ...
        {filteredCategories.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <FontAwesomeIcon icon={['fas', 'chevron-down'] as IconProp} />
                          </motion.div>
                        </button>
                        <AnimatePresence>
                          {isOpen && (
          ...
          <div className="text-center py-16">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[rgb(var(--muted)/0.08)] flex items-center justify-center">
              <FontAwesomeIcon icon={['fas', 'magnifying-glass'] as IconProp} className="text-2xl text-[rgb(var(--muted))]" />
            </div>

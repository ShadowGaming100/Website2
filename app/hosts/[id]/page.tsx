      ...
      <div className="container-default py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Tabs */}
            <div className="flex gap-1 p-1 bg-[rgb(var(--muted)/0.05)] rounded-xl overflow-x-auto scrollbar-hide">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
  ...
  return (
    <div className="bg-[#2f3136] rounded-2xl p-6">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="block w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-semibold text-center transition-all active:scale-98"
      >
        Join Server
      </a>
    </div>

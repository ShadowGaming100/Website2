      ...
      <div className="container-default">
        <div className="flex items-center justify-between h-20">
          <button
            ...
            className="md:hidden flex items-center justify-center w-10 h-10 rounded-xl hover:bg-[rgb(var(--muted)/0.1)] transition-colors"
            aria-label="Open menu"
          >
            <FontAwesomeIcon icon={['fas', 'bars']} className="text-lg text-[rgb(var(--muted))]" />
          </button>
